...
int main()
{
	...
	*/
	...
	a[0].real = 1; a[0].imag = 1;
	a[1].real = 4; a[1].imag = 4;
	a[2].real = 2; a[2].imag = 2;
	a[3].real = 5; a[3].imag = 5;
	a[4].real = 3; a[4].imag = 3;
	a[5].real = 6; a[5].imag = 6;
	...
	*/
	...
	b[0].real  = 1;  b[0].imag = 1;
	b[1].real  = 2;  b[1].imag = 2;
	b[2].real  = 3;  b[2].imag = 3;
	b[3].real  = 4;  b[3].imag = 4;
	b[4].real  = 5;  b[4].imag = 5;
	b[5].real  = 6;  b[5].imag = 6;
	b[6].real  = 7;  b[6].imag = 7;
	b[7].real  = 8;  b[7].imag = 8;
	b[8].real  = 9;  b[8].imag = 9;
	b[9].real  = 10; b[9].imag = 10;
	b[10].real = 11; b[10].imag = 11;
	b[11].real = 12; b[11].imag = 12;
